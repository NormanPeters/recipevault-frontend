    ...
    >
      ...
      <div class="col-span-2 row-span-3 rounded bg-white p-4 shadow">
        ...
        <div class="mb-4 grid grid-cols-2">
          <h2>Cooking Time</h2>
          <TextInput type="text" v-model="recipe.time" />
        </div>
        <!-- Ingredients Header -->
        <div class="mb-4 flex items-center justify-between">
          ...
          <div class="flex items-center space-x-1">
            <span>For</span>
            <TextInput class="w-16" type="number" v-model="recipe.servings" />
            <span>People</span>
          </div>
        </div>
      ...
      <div class="col-span-2 row-span-3 rounded bg-white p-4 text-left shadow">
        ...
        <div>
          <div
            v-for="(nutritionalValue, index) in recipe.nutritionalValues"
            :key="index"
